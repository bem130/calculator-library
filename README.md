...
- `sqrt` preserves perfect-square rational results exactly and recognizes simple radicals such as `sqrt(72) = 6sqrt(2)`, `sqrt(1/2) = sqrt(2)/2`, and `2^(1/2) = sqrt(2)`.
...
trigonometric known values, simple radical output, and `tan` pole errors.
