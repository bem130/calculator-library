...
* `pi`、`e`、exp/log の証明可能な恒等式と、bounded rational/dyadic endpoint に対する exp/log/asin/acos/atan と unit-range tan の certified interval。
...
* bounded real algebraic recognition for supported polynomial operations、整数累乗、cyclotomic trigonometric cases。
