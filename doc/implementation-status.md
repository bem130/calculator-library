...
* bounded real algebraic recognition for supported polynomial operations、整数累乗、正性を証明できる real algebraic の主平方根、cyclotomic trigonometric cases、degree-one algebraic result の rational collapse と後続の代数的演算への伝播。
