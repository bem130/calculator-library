...
const APPROXIMATE_COMPONENTS: &[(&str, &str, ExpectedExact)] = &[
    ...
    (
        "sin_periodic_non_degenerate",
        "sin(100+sin(1))",
        ExpectedExact::GeneralSymbolic,
    ),
    (
        "tan_periodic_non_degenerate",
        "tan(100+sin(1)/100)",
        ExpectedExact::GeneralSymbolic,
    ),
    ...
    (
        "asin_non_degenerate_negative_transform",
        "asin((-2-sin(1))/3)",
        ExpectedExact::GeneralSymbolic,
    ),
    ...
    (
        "acos_non_degenerate_negative_outer",
        "acos((-6+sin(1))/7)",
        ExpectedExact::GeneralSymbolic,
    ),
    (
