...
fn main() {
    ...
    let source = match case.as_str() {
        ...
        "approximate_exp_nondegenerate_unit" => Some(String::from("exp((1+sin(1))/4)")),
        ...
        "approximate_asin_three_fourths" => Some(String::from("asin(3/4)")),
        "approximate_asin_non_degenerate_unit" => Some(String::from("asin(sin(1)/3)")),
        "approximate_asin_non_degenerate_mid_transform" => Some(String::from("asin((1+sin(1))/3)")),
